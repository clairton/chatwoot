class Webhooks::Trigger
  ...
  def initialize(url, payload, webhook_type, secret: nil, delivery_id: nil, method: :post, headers: {})
    @url = url
    @payload = payload
  ...
  def self.execute(url, payload, webhook_type, secret: nil, delivery_id: nil, method: :post, headers: {})
    new(url, payload, webhook_type, secret: secret, delivery_id: delivery_id, method: method, headers: headers).execute
  end
